...
namespace yadi.dlms
{
	public class DlmsException : Exception
	{
		...
		private readonly DlmsExceptionReason[] reason;
		...
		public DlmsException(DlmsExceptionReason reason, string message) : base(message)
		{
			this.reason = new DlmsExceptionReason[]{reason};
		}

		public DlmsException(DlmsExceptionReason[] reasons, string message) : base(message)
		{
			this.reason = reasons;
		}
		...
		/// <returns> A DlmsExceptionReason </returns>
